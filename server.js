...
const IDler = {
  ...
  botSecret: "",
  botCallbackURL: "",
  sunucuID: "1051947940148690986",
  sunucuDavet: "https://discord.gg/B83Sd3H9dt",
  kodLogKanalı: "1092012345385041940",
  sahipRolü: "1084468684057215006",
  adminRolü: "1084468713295724574",
  kodPaylaşımcıRolü: "1084468726189006918",
  boosterRolü: "1085294976042278953",
  kodPaylaşamayacakRoller: ["BANLI ROL İD", "1084468770610884758"],
  hazırAltyapılarRolü: "Altyapı ROL İD",
  hazırSistemlerRolü: "1084468770610884758",
  elmasKodlarRolü: "1084468770610884758",
  altınKodlarRolü: "1084468770610884758",
  normalKodlarRolü: "1084468770610884758"
};
  ...
  new Strategy(
    {
      ...
      callbackURL: process.env.botCallbackURL,
      scope: scopes
    },
    ...
    return res.redirect(
      url.format({
        ...
        query: {
          statuscode: 137,
          message:
            "Ürünleri/Oyunları Görebilmek İçin Discord Sunucumuza Katılmanız | Siteye Giriş Yapmanız Gerekmektedir."
        }
      })
    );
    ...
    if (
      ...
      res.redirect(
        url.format({
          ...
          query: {
            statuscode: 501,
            message: "Bu Ürünü Görmek İçin Gerekli Rolün Yok."
          }
        })
      );
    }
    ...
    if (
      ...
      res.redirect(
        url.format({
          ...
          query: {
            statuscode: 501,
            message: "Bu Ürünü Görmek İçin Gerekli Rolünüz Yok."
          }
        })
      );
    }
        ...
        if (!id) {
          res.redirect(
            url.format({
              ...
              query: {
                statuscode: 504,
                message: "Bir Ürün İd'si Belirtin"
              }
            })
          );
        }
        ...
        if (!rank) {
          res.redirect(
            url.format({
              ...
              query: {
                statuscode: 504,
                message: "Bir Ürün rankı'si belirtin"
              }
            })
          );
        }
    ...
    return res.redirect(
      url.format({
        ...
        query: {
          statuscode: 138,
          message:
            "Ürün/Oyun paylaşabilmek için Discord sunucumuza katılmanız ve siteye giriş yapmanız gerekmektedir."
        }
      })
    );
...
app.post("/paylasim", (req, res) => {
  ...
  if (
    ...
    return res.redirect(
      url.format({
        ...
        query: {
          statuscode: 502,
          message: "Ürün/Oyun Paylaşma İznin Yok!"
        }
      })
    );
  if (
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    ...
    .setTimestamp()
    .setAuthor("Bir Ürün/Oyun Paylaşıldı!",client.user.avatarURL)
    .addField("Ürün/Oyun Bilgileri",`**Adı:** ${obj.isim} \n**Açıklaması:** ${obj.desc} \n**Paylaşan:** ${obj.k_adi}`)
.setThumbnail('https://cdn.discordapp.com/attachments/1051948414188929025/1089574031340089444/Resmi_Bildiri.png')
    .addField("Ürün/Oyun Sayfası", `[Tıkla!](https://likeable-lapis-turkey.glitch.me/${obj.kod_rank}/${obj.id})`));
